                        ...
                        <tbody>
                            ...
                            <?php $__currentLoopData = $transaksi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            <a href="/admin/transaksi/<?php echo e($item->id); ?>/edit"
                                                class="btn btn-sm btn-info"><i class="fas fa-edit"></i></a>
                                            <form action="<?php echo e(route('admin.transaksi.destroy', $item->id)); ?>"
                                                method="post">
...
<?php /**PATH E:\ucashier\resources\views/admin/transaksi/index.blade.php ENDPATH**/ ?>