    ...
    <div class="row">
        <div class="col-6">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('admin.produk.update', $produk->id)); ?>" method="post"
...
unset($__errorArgs, $__bag); ?>">
                                ...
                                <?php $__currentLoopData = $kategori; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($item->id); ?>" selected><?php echo e($item->nama_kategori); ?></option>
...
unset($__errorArgs, $__bag); ?>" placeholder="Harga"
...
unset($__errorArgs, $__bag); ?>" placeholder="Stok"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <?php if($produk->gambar == null): ?>
                            <img src="/<?php echo e($produk->gambar); ?>" alt="" style="display:none;">
                        <?php else: ?>
                            <img src="/<?php echo e($produk->gambar); ?>" alt="" style="width: 100%;">
                        <?php endif; ?>
                        <div>
...
unset($__errorArgs, $__bag); ?>" placeholder="Gambar"
...
<?php /**PATH E:\ucashier\resources\views/admin/produk/edit.blade.php ENDPATH**/ ?>